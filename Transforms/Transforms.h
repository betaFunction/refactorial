...
template <typename T> Transform *transform_factory() { return new T; }
...
#define REGISTER_TRANSFORM(transform)                                          \
  TransformRegistration _transform_registration_##transform(                   \
